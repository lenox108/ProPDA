...
Этот репозиторий — **форк** оригинального клиента ForPDA.

## Что изменено в этом форке
- Исправления поведения **клавиатуры/BBCode-панели** на Android 15/16 (edge-to-edge, OnePlus/OEM).
- Убрана опция **«Проверить обновления»** из настроек.

## Лицензия и авторство
Проект остаётся под **GPL v3**. Автор оригинального проекта указан ниже в секции лицензии.
