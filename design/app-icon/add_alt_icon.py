...
# сжимается до 50% холста adaptive-иконки. Считается ИМЕННО от квадрата мастера,
...
ART_SCALE = 0.50
# Тематический слой Android визуально увеличивается примерно в 1.5 раза.
# 46% оставляет аккуратный запас у Monet и monochrome даже под круглой маской.
MONO_SCALE = 0.46
