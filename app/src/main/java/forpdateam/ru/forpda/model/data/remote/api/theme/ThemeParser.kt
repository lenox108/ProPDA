...
class ThemeParser(
    ...
    fun parsePage(
        ...
        // Путь по разделам из навигационной строки: нужен, чтобы из темы можно было подняться в ЛЮБОЙ
        // раздел цепочки, а не только в непосредственный ([page.forumId]).
        page.forumPath = TopicForumPathParser.parse(response)
