 ...
 * добирает сообщения в реальном времени), а НЕ страницей диалога `act=qms&mid&t`: страница —
 * это «открытие диалога» со стороны сервера, и она рискует пометить сообщения прочитанными
 * ещё до того, как пользователь их увидел.
 *
