...
public class CodeEditor extends AppCompatEditText {
    /** До этой длины подсвечиваем весь текст; иначе только видимый фрагмент (очень длинные посты). */
    private static final int FULL_BB_HIGHLIGHT_MAX_CHARS = 65536;
    ...
    private Editable highlight(Editable e) {
        ...
        try {
            ...
            if (scrollView == null || e.length() <= FULL_BB_HIGHLIGHT_MAX_CHARS) {
                ...
                visibleStart = getOffsetForPosition(0, scrollY);
                visibleEnd = getOffsetForPosition(0, scrollY + scrollViewHeight);
