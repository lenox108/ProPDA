...
public class PaginationHelper {
    ...
    private void setupTabLayout(TabLayout tabLayout, boolean firstLast) {
        ...
        // Иначе TabLayout накладывает tabIconTint на выбранную вкладку — в тёмной теме стрелки «пропадают».
        ...
        for (TabLayout tabLayout : tabLayouts) {
            ...
            for (int i = 0; i < tabLayout.getTabCount(); i++) {
                ...
                if (tab.getIcon() != null) {
                    ...
                    boolean disabled = (tag == TAG_FIRST || tag == TAG_PREV) ? prevDisabled : nextDisabled;
                    tab.getIcon().setAlpha(disabled ? ICON_ALPHA_DISABLED : ICON_ALPHA_ENABLED);
                }
            }
        }
    }
