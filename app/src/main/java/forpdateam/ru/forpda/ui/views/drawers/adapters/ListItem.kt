...
enum class OtherMenuSection {
    ...
    /**
     * Зона нижней панели: показывается только в режиме редактирования меню, чтобы плитку
     * можно было перетащить вниз или обратно. В обычном виде панель и так на экране,
     * дублировать её сверху незачем.
     */
    BOTTOM,
}
