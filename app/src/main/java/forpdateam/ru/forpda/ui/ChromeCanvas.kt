 ...
 * держалось раньше, — это M3-тон 100 (чистый белый), а в тёмной теме —
 * DarkFloor-пин (сейчас lStar 6 с оттенком обоев, исторически бесцветный
 * #121212): подтон либо отсутствовал, либо слишком слаб, полотно почти не
 * реагировало на обои («светлый или тёмный по теме, а не по обоям» — жалоба).
 * Канонические M3-поверхности (surfaceContainer
