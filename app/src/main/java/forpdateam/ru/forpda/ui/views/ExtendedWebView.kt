...
open class ExtendedWebView @JvmOverloads constructor(
    ...
    fun setAppFontMode(mode: forpdateam.ru.forpda.ui.AppFontMode) {
        ...
        evalJs(
            ...
            document.documentElement.classList.remove(${FontController.ROBOTO_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.INTER_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.SOURCE_SANS_3_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.OPEN_SANS_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.IBM_PLEX_SANS_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.GOLOS_TEXT_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.LITERATA_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.APPETITE_PRO_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.MAYONEZ_ITALIC_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.SYSTEM_WEB_FONT_CLASS.jsStringLiteral()}, ${FontController.ROBOTO_MONO_WEB_FONT_CLASS.jsStringLiteral()});
