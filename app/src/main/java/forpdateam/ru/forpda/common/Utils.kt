...
object Utils {
    ...
    /**
     * Текст из буфера. Раньше проверяли только MIMETYPE_TEXT_PLAIN — многие приложения кладут
     * text/html или другие типы, из‑за этого «Цитата из буфера» молча ничего не делала.
     */
    fun readFromClipboard(): String? {
        ...
        val text = item.coerceToText(ctx)?.toString()?.trim().orEmpty()
